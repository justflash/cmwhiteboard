...
describe("cmwhiteboard", function() {  
	var wb=require('../../index').Whiteboard;//Whiteboard;
	var inst;
	window.$=jQuery;
	console.log(jQuery);
	...
	cont.id="test-cont";
	cont.name="test-cont";
	$(cont).css({width:'600px',height:'600px'});
	document.body.appendChild(cont);
   // inst=new wb("test-cont",false,{showTemplates: false});
   // inst.setWhiteboardViewPort(600,600);
    beforeEach(function() {
        //    
    });

it("should call whiteboardIsReady when initialized!", function(done) {
    inst=wb.addWhiteboard(document,"test-cont",{isReadOnly:false,width:800,height:600,showTemplates:false});
